...
1. 洗脑那里其实和权利，控制有关。第三方为什么要有这些叙事，去不让个人精神独立，可以再延伸一些。
2. 精神独立的定义纠结了一些时候在精神独立本身涉及不涉及到执行层面？当时纠结了很久。后来觉得不要涉及到执行了吧。精神独立本身就是没有第三方代替思考，自己有自我意识。执行的话就是怎样实现精神独立是另一个问题，不在这个定义里。
