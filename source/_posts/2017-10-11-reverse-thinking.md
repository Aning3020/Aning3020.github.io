...
# 贝叶斯定理中的逆向思维－备择假设项
[贝叶斯定理](https://zh.wikipedia.org/zh-cn/%E8%B4%9D%E5%8F%B6%E6%96%AF%E5%AE%9A%E7%90%86)的二中择一形式中，充分说明了贝叶斯定理是一个由结果推导原因，由已知倒未知的过程。由四项P(-B),P(B),P(A|B),P(A|-B)能够导出P(B|A)，其中P(A|-B)通常表示备择假设导致结果A出现的概率，此项是正常思维容易忽视的一项，它往往代表大脑容易忽视的反例。（A是结果，是收集到的有关假设的数据。B是焦点假设，-B是备择假设。）
